        ...
        <div class="container"><hr></div>
            ...
            <div class="container">
               ...
               <div class="container fdo_corpo">
                     <br />
                    <form action="secao.php?secao=vendedor&acao=buscarAlterar" method="POST" name="frm_vendedor">
                        <legend class="text-center">Pesquisa Vendedor</legend>
                        <div class="controls controls-row">
                        
                            <input class="span7" type="text" placeholder="Digite o Nome ou Parte do nome para Pesquisar" title="Digite o Nome ou Parte do nome para Pesquisar" name="txt_nome">
                     ...
                     <?php
                        ...
                        if($_enviar){
                            ...
                            $_vendedor->BuscarVendedorNomeId($_nome);
