        ...
        <div class="container"><hr></div>
            ...
            <div class="container">
               ...
               <div class="container fdo_corpo">
                     <br />
                    <form action="secao.php?secao=linha&acao=buscarAlterar" method="POST" name="frm_cliente">
                    <fieldset>
                    <legend class="text-center">Pesquisa Linha</legend>
                    ...
                    <?php
                       ...
                       if($_enviar){
                           ...
                           $_linha->BuscarLinhaNomeId($_nome);
