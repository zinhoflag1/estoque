...
<body>
	<div class="container">
		...
		<legend class="text-center">Relatório de Pedidos Quitados</legend>
...
if ($_btn_enviar) {
	...
	$_dados = $_relatorio->PedidoQuitado ( $_txt_dt_inicial, $_txt_dt_final );
	...
	if ($_total_registro == 0) {
		...
		print "<table class=\"table\" border=\"0\">
			<tr>
				...
				<td bgcolor='cbccda'>Data Pgto</td>
		...
		<td>" . DataMysql::dataVisual ( $_dados [$i] ['dt_pedido'] ) . "</td>
				<td>" . DataMysql::dataVisual ( $_dados [$i] ['dt_pgto'] ) . "</td>
